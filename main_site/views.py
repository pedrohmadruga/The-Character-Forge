...
class RecreationBuildsView(ListView):
    model = models.PersonagemRecriado
    template_name = 'recreation_builds.html'
    context_object_name = 'personagens'
    paginate_by = 5
...
class PersonagemRecreationDetailView(DetailView):
    model = models.PersonagemRecriado
    template_name = 'recreation_character_detail.html'
    context_object_name = 'personagem'